...
@Component({
  selector: 'app-display-data-handling-event',
  templateUrl: './display-data-handling-event.component.html',
  styleUrls: ['./display-data-handling-event.component.scss']
})
export class DisplayDataHandlingEventComponent implements OnInit {
  title: string = 'Display data & Handling events';
  ...
  firstName!: string;
  lastName!: string;
  person: any = { firstName: this.firstName, lastName: this.lastName };
