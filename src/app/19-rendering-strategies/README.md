...
This note compares the common rendering strategies and gives quick commands/snippets. "SGA" is not an official Angular term; here it means _static generation with Angular_ (a hybrid that can mix CSR/SSR/SSG per route). If you meant something else by SGA, tell me and I will adjust.
...
Next Section: [Angular Testing](/src/app/20-angular-testing/README.md)
